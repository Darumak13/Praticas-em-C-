...
int main ()
{
    int n, Op, quartoAlugel, puxa_quarto = 0, troca_situacao;
    ...
    while (Op != 7) {
        ...
        case 5:
            ...
            cout << "Qual seria o número do quarto: ";
            cin >> puxa_quarto;
            cout << "Qual seria o valor da despensa extra do quarto: " << Hotel[puxa_quarto].numero_do_quarto << ": ";
            cin >> Hotel[puxa_quarto].Quarto_despensa_extra;
            cin.ignore ();
            Hotel[puxa_quarto].Quarto_despensas += Hotel[puxa_quarto].Quarto_despensa_extra;
            Menu_Hotel ();
            cin >> Op;
            cin.ignore ();
            Limpa ();
        ...
        case 6:
            Limpa ();
            cout << "-------------------" << endl;
            cout << "Calculo das despensas dos quartos" << endl;
            for (int i = 0; i < n; i++) {
