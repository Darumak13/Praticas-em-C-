...
int main ()
{
    ...
    int maiorIdade    = 0;
    double contPorcen = 0.0, cont_Habitantes = 0.0, resul_Habitantes = 0.0;
    int opcao;
    ...
    resul_Habitantes = contPorcen * 100 / cont_Habitantes;

    // Imprime a porcentagem de habitantes com os requesitos impostos
    cout << resul_Habitantes << "% "  "dos habitantes são do sexo feminino tem idade entre 18 e 35 anos, e que tenha olhos verdes e cabelos louros. ";
