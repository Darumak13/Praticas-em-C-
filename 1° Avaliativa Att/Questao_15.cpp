...
// Strutura que guarda as variaveis para o vetor de clientes
struct cliente {
...
int main ()
{
    ...
    while (Op != 6)
    {
        ...
        case 2: 
            // Cadastra as milhagens de todos os clientes
            Limpa();
        ...
        case 3:
            // Lista a milhagem e o nome do cliente desejado
            Limpa();
        ...
        case 4:
            // Imprime o nome dos clientes que têm a menor e a maior milhagem
        ...
        case 5:
            // Imprime o nome a milhagem de todos os clientes
